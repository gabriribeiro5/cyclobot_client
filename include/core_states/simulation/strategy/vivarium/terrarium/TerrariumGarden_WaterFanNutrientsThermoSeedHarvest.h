...
class TerrariumGarden_WaterFanNutrientsThermoSeedHarvest : public BaseStrategy {
    public:
        TerrariumGarden_WaterFanNutrientsThermoSeedHarvest();

        void enter() override;
        void setup() override;
        void simulate_environment(EcosystemParameters *ecosystemParamPtr, EcosystemScanner *scannerPtr, EcosystemActuator *actuatorPtr) override;
        void exit() override;    
    private:

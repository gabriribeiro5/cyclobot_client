...
class EcosystemParameters {
    public:
        ...
        const PROGMEM int currentTemperature = 20;                     // valor de tensão de comparação do sensor / valor máximo = Não sei / média esperada 20 graus
        ...
        const PROGMEM int climate = 1;                                 // 0 = abaixo de 18 graus; 1 = entre 18 e 22 graus; 2 = mais de 22 graus
        const PROGMEM bool soilIsWet = 1;                              // condição de solo úmido; 1 = solo umido
        const PROGMEM bool sunLightAvailable = 1;                     // condição de iluminação; 1 = dia; 0 = noite

#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/hidro_garden/HidroponicGarden_WaterFanNutrientsThermoSeedHarvest.h"
...
void HidroponicGarden_WaterFanNutrientsThermoSeedHarvest::enter() {
...
void HidroponicGarden_WaterFanNutrientsThermoSeedHarvest::setup() {
...
void HidroponicGarden_WaterFanNutrientsThermoSeedHarvest::simulate_environment(EcosystemParameters *parametersPtr,
...
void HidroponicGarden_WaterFanNutrientsThermoSeedHarvest::exit() {
    return;
}
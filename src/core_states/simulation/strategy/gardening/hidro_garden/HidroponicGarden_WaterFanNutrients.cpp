#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/hidro_garden/HidroponicGarden_WaterFanNutrients.h"
...
void HidroponicGarden_WaterFanNutrients::enter() {
...
void HidroponicGarden_WaterFanNutrients::setup() {
...
void HidroponicGarden_WaterFanNutrients::simulate_environment(EcosystemParameters *parametersPtr,
...
void HidroponicGarden_WaterFanNutrients::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/hidro_garden/HidroponicGarden_WaterFan.h"
...
void HidroponicGarden_WaterFan::enter() {
...
void HidroponicGarden_WaterFan::setup() {
...
void HidroponicGarden_WaterFan::simulate_environment(EcosystemParameters *parametersPtr,
...
void HidroponicGarden_WaterFan::exit() {
    return;
}
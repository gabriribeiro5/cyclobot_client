#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/hidro_garden/HG_WaterFanLightNutrient.h"
...
/* HIDROPONIC GARDEN */
void HG_WaterFanLightNutrient::enter() {
...
/* HIDROPONIC GARDEN */
void HG_WaterFanLightNutrient::setup(VisualComm *visualCommPtr) {
...
/* HIDROPONIC GARDEN */
void HG_WaterFanLightNutrient::simulate_ecosystem(EcosystemParameters *parametersPtr,
...
/* HIDROPONIC GARDEN */
void HG_WaterFanLightNutrient::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/hidro_garden/HG_WaterFanLightNutrientThermo.h"
...
/* HIDROPONIC GARDEN */
void HG_WaterFanLightNutrientThermo::enter() {
...
/* HIDROPONIC GARDEN */
void HG_WaterFanLightNutrientThermo::setup(VisualComm *visualCommPtr) {
...
/* HIDROPONIC GARDEN */
void HG_WaterFanLightNutrientThermo::simulate_ecosystem(EcosystemParameters *parametersPtr,
...
/* HIDROPONIC GARDEN */
void HG_WaterFanLightNutrientThermo::exit() {
    return;
}
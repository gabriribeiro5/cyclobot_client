#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/hidro_garden/HidroponicGarden_WaterFanNutrientsThermo.h"
...
void HidroponicGarden_WaterFanNutrientsThermo::enter() {
...
void HidroponicGarden_WaterFanNutrientsThermo::setup() {
...
void HidroponicGarden_WaterFanNutrientsThermo::simulate_environment(EcosystemParameters *parametersPtr,
...
void HidroponicGarden_WaterFanNutrientsThermo::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/hidro_garden/HidroponicGarden_WaterFanNutrientsThermoHarvest.h"
...
void HidroponicGarden_WaterFanNutrientsThermoHarvest::enter() {
...
void HidroponicGarden_WaterFanNutrientsThermoHarvest::setup() {
...
void HidroponicGarden_WaterFanNutrientsThermoHarvest::simulate_environment(EcosystemParameters *parametersPtr,
...
void HidroponicGarden_WaterFanNutrientsThermoHarvest::exit() {
    return;
}
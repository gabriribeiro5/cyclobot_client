#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/trad_garden/TraditionalGarden_WaterFanNutrientsThermoSeedHarvest.h"
...
void TraditionalGarden_WaterFanNutrientsThermoSeedHarvest::enter() {
...
void TraditionalGarden_WaterFanNutrientsThermoSeedHarvest::setup() {
...
void TraditionalGarden_WaterFanNutrientsThermoSeedHarvest::simulate_environment(EcosystemParameters *parametersPtr,
...
void TraditionalGarden_WaterFanNutrientsThermoSeedHarvest::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/trad_garden/TraditionalGarden_WaterFan.h"
...
void TraditionalGarden_WaterFan::enter() {
...
void TraditionalGarden_WaterFan::setup() {
...
void TraditionalGarden_WaterFan::simulate_environment(EcosystemParameters *parametersPtr,
...
void TraditionalGarden_WaterFan::exit() {
    return;
}
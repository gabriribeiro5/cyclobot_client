#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/trad_garden/TraditionalGarden_WaterFanNutrients.h"
...
void TraditionalGarden_WaterFanNutrients::enter() {
...
void TraditionalGarden_WaterFanNutrients::setup() {
...
void TraditionalGarden_WaterFanNutrients::simulate_environment(EcosystemParameters *parametersPtr,
...
void TraditionalGarden_WaterFanNutrients::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/grass_wall/GrassWall_WaterFan.h"
...
void GrassWall_WaterFan::simulate_environment(EcosystemParameters *parametersPtr,

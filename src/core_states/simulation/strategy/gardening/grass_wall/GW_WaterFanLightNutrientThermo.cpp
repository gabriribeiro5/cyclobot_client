#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/grass_wall/GW_WaterFanLightNutrientThermo.h"
...
/* GRASS WALL */
void GW_WaterFanLightNutrientThermo::enter() {
...
/* GRASS WALL */
void GW_WaterFanLightNutrientThermo::setup(VisualComm *visualCommPtr) {
...
/* GRASS WALL */
void GW_WaterFanLightNutrientThermo::simulate_ecosystem(EcosystemParameters *parametersPtr,
...
/* GRASS WALL */
void GW_WaterFanLightNutrientThermo::exit() {
    return;
}
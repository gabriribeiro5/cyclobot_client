#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/grass_wall/GrassWall_WaterFanNutrientsThermo.h"
...
void GrassWall_WaterFanNutrientsThermo::enter() {
...
void GrassWall_WaterFanNutrientsThermo::setup() {
...
void GrassWall_WaterFanNutrientsThermo::simulate_environment(EcosystemParameters *parametersPtr,
...
void GrassWall_WaterFanNutrientsThermo::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/grass_wall/GW_WaterFanLightNutrient.h"
...
/* GRASS WALL */
void GW_WaterFanLightNutrient::enter() {
...
/* GRASS WALL */
void GW_WaterFanLightNutrient::setup(VisualComm *visualCommPtr) {
...
/* GRASS WALL */
void GW_WaterFanLightNutrient::simulate_ecosystem(EcosystemParameters *parametersPtr,
...
/* GRASS WALL */
void GW_WaterFanLightNutrient::exit() {
    return;
}
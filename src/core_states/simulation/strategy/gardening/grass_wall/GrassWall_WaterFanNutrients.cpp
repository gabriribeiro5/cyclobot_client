#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/grass_wall/GrassWall_WaterFanNutrients.h"
...
void GrassWall_WaterFanNutrients::enter() {
...
void GrassWall_WaterFanNutrients::setup() {
...
void GrassWall_WaterFanNutrients::simulate_environment(EcosystemParameters *parametersPtr,
...
void GrassWall_WaterFanNutrients::exit() {
    return;
}
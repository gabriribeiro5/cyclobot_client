#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/grass_wall/GrassWall_Water.h"
...
void GrassWall_Water::simulate_environment(EcosystemParameters *parametersPtr,

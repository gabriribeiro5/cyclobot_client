...
void AeroponicGarden_WaterFanNutrientsThermoHarvest::enter() {
...
void AeroponicGarden_WaterFanNutrientsThermoHarvest::setup() {
...
void AeroponicGarden_WaterFanNutrientsThermoHarvest::simulate_environment(EcosystemParameters *parametersPtr,
...
void AeroponicGarden_WaterFanNutrientsThermoHarvest::exit() {
    return;
}
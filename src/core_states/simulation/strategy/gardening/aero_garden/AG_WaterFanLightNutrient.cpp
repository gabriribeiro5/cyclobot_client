#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/aero_garden/AG_WaterFanLightNutrient.h"
...
/* AEROPONIC GARDEN */
void AG_WaterFanLightNutrient::enter() {
...
/* AEROPONIC GARDEN */
void AG_WaterFanLightNutrient::setup(VisualComm *visualCommPtr) {
...
/* AEROPONIC GARDEN */
void AG_WaterFanLightNutrient::simulate_ecosystem(EcosystemParameters *parametersPtr,
...
/* AEROPONIC GARDEN */
void AG_WaterFanLightNutrient::exit() {
    return;
}
...
void AeroponicGarden_WaterFan::enter() {
...
void AeroponicGarden_WaterFan::setup() {
...
void AeroponicGarden_WaterFan::simulate_environment(EcosystemParameters *parametersPtr,
...
void AeroponicGarden_WaterFan::exit() {
    return;
}
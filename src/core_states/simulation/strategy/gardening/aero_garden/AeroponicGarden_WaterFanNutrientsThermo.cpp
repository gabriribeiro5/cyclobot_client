...
void AeroponicGarden_WaterFanNutrientsThermo::enter() {
...
void AeroponicGarden_WaterFanNutrientsThermo::setup() {
...
void AeroponicGarden_WaterFanNutrientsThermo::simulate_environment(EcosystemParameters *parametersPtr,
...
void AeroponicGarden_WaterFanNutrientsThermo::exit() {
    return;
}
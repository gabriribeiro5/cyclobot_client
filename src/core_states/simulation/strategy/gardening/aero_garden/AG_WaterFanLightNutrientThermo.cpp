#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/aero_garden/AG_WaterFanLightNutrientThermo.h"
...
/* AEROPONIC GARDEN */
void AG_WaterFanLightNutrientThermo::enter() {
...
/* AEROPONIC GARDEN */
void AG_WaterFanLightNutrientThermo::setup(VisualComm *visualCommPtr) {
...
/* AEROPONIC GARDEN */
void AG_WaterFanLightNutrientThermo::simulate_ecosystem(EcosystemParameters *parametersPtr,
...
/* AEROPONIC GARDEN */
void AG_WaterFanLightNutrientThermo::exit() {
    return;
}
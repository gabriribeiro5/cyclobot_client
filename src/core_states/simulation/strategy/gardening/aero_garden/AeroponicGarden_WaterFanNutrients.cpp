...
void AeroponicGarden_WaterFanNutrients::enter() {
...
void AeroponicGarden_WaterFanNutrients::setup() {
...
void AeroponicGarden_WaterFanNutrients::simulate_environment(EcosystemParameters *parametersPtr,
...
void AeroponicGarden_WaterFanNutrients::exit() {
    return;
}
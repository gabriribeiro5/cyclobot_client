...
void AeroponicGarden_Water::enter() {
...
void AeroponicGarden_Water::setup() {
...
void AeroponicGarden_Water::simulate_environment(EcosystemParameters *parametersPtr,
...
void AeroponicGarden_Water::exit() {
    return;
}
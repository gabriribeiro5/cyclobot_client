#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/gardening/aero_garden/AeroponicGarden_WaterFanNutrientsThermoSeedHarvest.h"
...
void AeroponicGarden_WaterFanNutrientsThermoSeedHarvest::enter() {
...
void AeroponicGarden_WaterFanNutrientsThermoSeedHarvest::setup() {
...
void AeroponicGarden_WaterFanNutrientsThermoSeedHarvest::simulate_environment(EcosystemParameters *parametersPtr,
...
void AeroponicGarden_WaterFanNutrientsThermoSeedHarvest::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/vivarium/paludarium/Paludarium_WaterFanNutrientsThermoHarvest.h"
...
void Paludarium_WaterFanNutrientsThermoHarvest::enter() {
...
void Paludarium_WaterFanNutrientsThermoHarvest::setup() {
...
void Paludarium_WaterFanNutrientsThermoHarvest::simulate_environment(EcosystemParameters *parametersPtr,
...
void Paludarium_WaterFanNutrientsThermoHarvest::exit() {
    return;
}
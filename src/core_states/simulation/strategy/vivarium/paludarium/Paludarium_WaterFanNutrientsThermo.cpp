#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/vivarium/paludarium/Paludarium_WaterFanNutrientsThermo.h"
...
void Paludarium_WaterFanNutrientsThermo::enter() {
...
void Paludarium_WaterFanNutrientsThermo::setup() {
...
void Paludarium_WaterFanNutrientsThermo::simulate_environment(EcosystemParameters *parametersPtr,
...
void Paludarium_WaterFanNutrientsThermo::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/vivarium/terrarium/TerrariumGarden_WaterFanNutrients.h"
...
void TerrariumGarden_WaterFanNutrients::enter() {
...
void TerrariumGarden_WaterFanNutrients::setup() {
...
void TerrariumGarden_WaterFanNutrients::simulate_environment(EcosystemParameters *parametersPtr,
...
void TerrariumGarden_WaterFanNutrients::exit() {
    return;
}
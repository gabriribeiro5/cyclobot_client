#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/vivarium/aquarium/AQ_LightNutrientThermo.h"
...
/* AQUARIUM */
void AQ_LightNutrientThermo::enter() {
...
/* AQUARIUM */
void AQ_LightNutrientThermo::setup(VisualComm *visualCommPtr) {
...
/* AQUARIUM */
void AQ_LightNutrientThermo::simulate_ecosystem(EcosystemParameters *parametersPtr,
...
/* AQUARIUM */
void AQ_LightNutrientThermo::exit() {
    return;
}
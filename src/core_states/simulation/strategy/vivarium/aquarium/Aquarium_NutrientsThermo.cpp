#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/vivarium/aquarium/Aquarium_NutrientsThermo.h"
...
void Aquarium_NutrientsThermo::enter() {
...
void Aquarium_NutrientsThermo::setup() {
...
void Aquarium_NutrientsThermo::simulate_environment(EcosystemParameters *parametersPtr,
...
void Aquarium_NutrientsThermo::exit() {
    return;
}
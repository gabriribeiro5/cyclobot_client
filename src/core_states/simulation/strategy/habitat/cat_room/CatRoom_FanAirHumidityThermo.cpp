#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/habitat/cat_room/CatRoom_FanAirHumidityThermo.h"
...
void CatRoom_FanAirHumidityThermo::enter() {
...
void CatRoom_FanAirHumidityThermo::setup() {
...
void CatRoom_FanAirHumidityThermo::simulate_environment(EcosystemParameters *parametersPtr,
...
void CatRoom_FanAirHumidityThermo::exit() {
    return;
}
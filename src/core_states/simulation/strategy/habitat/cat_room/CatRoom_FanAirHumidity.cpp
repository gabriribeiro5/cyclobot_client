#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/habitat/cat_room/CatRoom_FanAirHumidity.h"
...
void CatRoom_FanAirHumidity::enter() {
...
void CatRoom_FanAirHumidity::setup() {
...
void CatRoom_FanAirHumidity::simulate_environment(EcosystemParameters *parametersPtr,
...
void CatRoom_FanAirHumidity::exit() {
    return;
}
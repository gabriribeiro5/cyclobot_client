#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/habitat/home_room/HomeRoom_FanAirHumidity.h"
...
void HomeRoom_FanAirHumidity::enter() {
...
void HomeRoom_FanAirHumidity::setup() {
...
void HomeRoom_FanAirHumidity::simulate_environment(EcosystemParameters *parametersPtr,
...
void HomeRoom_FanAirHumidity::exit() {
    return;
}
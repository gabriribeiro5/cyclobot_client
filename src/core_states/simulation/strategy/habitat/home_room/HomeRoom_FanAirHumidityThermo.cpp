#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/habitat/home_room/HomeRoom_FanAirHumidityThermo.h"
...
void HomeRoom_FanAirHumidityThermo::enter() {
...
void HomeRoom_FanAirHumidityThermo::setup() {
...
void HomeRoom_FanAirHumidityThermo::simulate_environment(EcosystemParameters *parametersPtr,
...
void HomeRoom_FanAirHumidityThermo::exit() {
    return;
}
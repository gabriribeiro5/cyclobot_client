#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/habitat/home_room/HR_LightFanThermoHumidifier.h"
...
/* HOME ROOM */
void HR_LightFanThermoHumidifier::enter() {
...
/* HOME ROOM */
void HR_LightFanThermoHumidifier::setup(VisualComm *visualCommPtr) {
...
/* HOME ROOM */
void HR_LightFanThermoHumidifier::simulate_ecosystem(EcosystemParameters *parametersPtr,
...
/* HOME ROOM */
void HR_LightFanThermoHumidifier::exit() {
    return;
}
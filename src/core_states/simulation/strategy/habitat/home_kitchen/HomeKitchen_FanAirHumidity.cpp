#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/habitat/home_kitchen/HomeKitchen_FanAirHumidity.h"
...
void HomeKitchen_FanAirHumidity::enter() {
...
void HomeKitchen_FanAirHumidity::setup() {
...
void HomeKitchen_FanAirHumidity::simulate_environment(EcosystemParameters *parametersPtr,
...
void HomeKitchen_FanAirHumidity::exit() {
    return;
}
#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/habitat/home_kitchen/HomeKitchen_FanAirHumidityThermo.h"
...
void HomeKitchen_FanAirHumidityThermo::enter() {
...
void HomeKitchen_FanAirHumidityThermo::setup() {
...
void HomeKitchen_FanAirHumidityThermo::simulate_environment(EcosystemParameters *parametersPtr,
...
void HomeKitchen_FanAirHumidityThermo::exit() {
    return;
}
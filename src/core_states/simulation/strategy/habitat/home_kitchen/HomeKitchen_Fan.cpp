#include <Arduino.h>
#include "../../../../../../include/core_states/simulation/strategy/habitat/home_kitchen/HomeKitchen_Fan.h"
...
void HomeKitchen_Fan::simulate_environment(EcosystemParameters *parametersPtr,

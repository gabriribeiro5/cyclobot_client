...
// comm
void ErrorHandlingState::report_ecosystem_data(FiniteStateMachine *cyclobot) {
    cyclobot->selfPtr->errorHandlerPtr->log_error_msg(cyclobot->paramPtr->errorHandlingParametersPtr, cyclobot->commPtr->visualCommPtr, "ErrorHandlingState", "report_ecosystem_data", 0, "wrong state");
};

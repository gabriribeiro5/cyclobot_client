...
void StrategyContext::setup(BaseStrategy *simulationStrategyPtr, ConfigData *configDataPtr, VisualComm *visualCommPtr, RTC_DS1307 *rtcPtr) {
    simulationStrategyPtr->create_pin_map(configDataPtr, visualCommPtr, rtcPtr);
    simulationStrategyPtr->board_setup(configDataPtr, visualCommPtr, rtcPtr);
    simulationStrategyPtr->create_params(configDataPtr, visualCommPtr, rtcPtr);
}

void StrategyContext::simulate_ecosystem(EcosystemScanner *scannerPtr, EcosystemActuator *actuatorPtr, ConfigData *configDataPtr, BaseStrategy *simulationStrategyPtr, VisualComm *visualCommPtr, RTC_DS1307 *rtcPtr) {
